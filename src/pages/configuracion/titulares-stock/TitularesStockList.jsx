...
export default function TitularesStockList() {
  ...
  const cargar = useCallback(async () => {
    ...
    try {
      ...
      const res = await api.get(`/api/titulares-stock?${params.toString()}`)
  ...
  async function confirmarEliminar() {
    ...
    setErrorEliminar('')
    try {
      await api.delete(`/api/titulares-stock/detalle?id=${aEliminar.id}`)
      setAEliminar(null)
      cargar()
    } catch (err) {
