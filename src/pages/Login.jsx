  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-slate-400 rounded-xl shadow-sm p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                />
                <Mail size={16} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-600" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full border border-slate-400 rounded-lg px-3 py-2.5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
                <button
                  type="button"
          ...
          <div className="mt-4 flex items-center justify-center gap-1.5 text-xs text-slate-700">
